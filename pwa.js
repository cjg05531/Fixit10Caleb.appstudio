...
const cacheName = 'Fixit10CalebGebhardt-2020-10-25 21:04:26.479683'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit10CalebGebhardt'.length) === 'Fixit10CalebGebhardt') {
